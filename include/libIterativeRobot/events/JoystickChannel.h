...
class JoystickChannel : public Trigger {
  ...
  public:
    ...
    void whenPassingThresholdForward(Command* command, Action action);
    void whilePastThreshold(Command* command, Action action);
    void whenPassingThresholdReverse(Command* command, Action action);
    void whileWithinThreshold(Command* command, Action action);
